...
*Signed program. Source: `/URITP SOPs/PPE Program.docx`, last revised 13 August 2025 — eleven months old, so treat the specifics as due for a walk-through.*
...
*Converted from the Word original on 29 July 2026, wording unchanged. The availability list was reorganized by location rather than by item, because "what is in this room" is the question you have standing in the doorway, but no requirement was added, removed or reworded. The original carried an empty `related programs:` field worth filling — this program cites hardhats in lifts, which is a MEWP dependency nobody linked; fire prevention, hazard communication for solvents, and ladder and scaffold work are the other obvious neighbours.*
